...
function changeMenuIcon() {
  if (document.getElementById('menu-bars-icon').className == 'fa-solid fa-bars') {
...
function createBillResult(category, amount) {
  ...
  document.getElementById('result-bills-list').appendChild(result_bill).appendChild(result_bill_div).appendChild(result_bill_div_span).append(result_bill_delete);
}
...
document.getElementById('nhif-contribution').innerHTML = `Ksh. ${nhifContribution}`;
document.getElementById('nssf-contribution').innerHTML = `Ksh. ${nssfContribution}`;
document.getElementById('insurance-relief').innerHTML = `Ksh. ${insuranceRelief}`;
document.getElementById('personal-relief').innerHTML = `Ksh. ${personalRelief}`;

let totalTax = nhifContribution + nssfContribution + insuranceRelief + personalRelief;
...
const getRemainingAmount = () => {
  ...
  document.getElementById('remaining-amount').innerHTML = `Ksh. ${remainingAmount}`;
}